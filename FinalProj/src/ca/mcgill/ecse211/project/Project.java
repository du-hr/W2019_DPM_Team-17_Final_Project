...
public class Project {
	...
	private static int URx = 5;
	private static int URy = 5;
	...
	public static void main(String[] args) throws OdometerExceptions{
	    ...
	    Navigation simpleNavigation = new Navigation (odometer, leftMotor, rightMotor, WHEEL_RAD);
	    simpleNavigation.travelTo(0, TILE_SIZE);
	    simpleNavigation.travelTo(TILE_SIZE, TILE_SIZE);
	    gyro_sp.fetchSample(gyro_sample, 0);
	    double angle = gyro_sample[0];
		if(angle < 0) {
			angle += 360;
		}
		angle = 360 - angle;
