...
public class LightLocalization {
    ...
    public void localize() {
        ...
        leftMotor.stop(true);
        rightMotor.stop();
        double dX, dY, thetax, thetay;//Variables used to calculate the 0ï¿½ direction and the origin
        //From the 4 angles stored, calculate how off from the origin and 0ï¿½ the robot is
